        ...
        <div class="container mt-5" style="background-color:#e690d3;">
               <div class="row mt-2 d-flex justify-content-center">
                  ...
                  <div class="col-2"><a href="../multiplication1/multiplication.php" class="btn btn-dark animated infinite tada delay-2s">Etape1</a></div>
                   <div class="col-2"><a href="../multiplication2/checkmultiple.php" class="btn btn-dark animated infinite tada delay-3s">Etape2</a></div>
                   <div class="col-2"><a href="../multiplication3/multiplication3.php" class="btn btn-dark animated infinite tada delay-4s">Etape3</a></div>
               </div>
            </div>
         <div class="container jumbotron mt-4" style="background-color:#510a41;">
             <div class="card card-info">
                <div class="card-heiding"><h1 class="card-title" style="background-color: #510a41; text-align: center; color: white;">Etape 4: Cochez une table pour repondre aux questions ?</h1></div>
                     <div class="card-body">
                         <form method="POST" action="multiplication4.php">
                             <div class="row mt-1">
                                <div class="col-6">
                                    <?php
                                          for ($i=0; $i <=5 ; $i++) { 
